...
#NOTE =>
#1) ADD  A print() STATEMENT STATING THAT (-22,22) ARE THE BEST INPUTS AS THEY COVER THE WHOLE SCREEN WHEN THE
#   GAME IS COMPLETE
#2) MAY NEED TO SET-UP SELECTED_ELEMS FOR CALCULATION IN FUTURE
Game_Of_Life()